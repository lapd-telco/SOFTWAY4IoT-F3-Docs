...
//Send front-end files for the client
app.get('/', function (req, res) {
	res.sendFile( path.join( __dirname, 'www/'))
});

//In every new socket created, the socket id is printed in console. 
...
//Send command request (updateContext) to ORION after the button click in front-end
app.post('/sendcommand', function (req, res) {
	...
	// axios(requestOptions)
	// 	.then(function (response) {
	// 		//console.log(response.data.contextResponses[0].statusCode);
